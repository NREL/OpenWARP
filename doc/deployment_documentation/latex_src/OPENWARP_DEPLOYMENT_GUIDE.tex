...
\subsection{Windows}
 installer.bat is the install script that is certified for Windows 7 x64. Always run this script as Administrator for succesfull copy operations.It brings down all the prerequistie to get started. installer.bat could be edit to add/modify new logics.
 \begin{itemize}

...
Installer.bat brings-down all the prerequistie to get started and configure path and dlls to get started. installer.bat could be edit to add/modify new logics.
 ...
 \end{itemize}
 After the installation is done, Execute run.bat from the source directory to Open GUI.
 Similarly, to run automated testscripts, you can run testscript_1.bat and testscript_2.bat. To know more about CLI, refer OpenWARPCLIdocumentation.pdf
...
After the installation is done, Execute run.sh from the source directory to Open GUI.
 Similarly, to run automated testscripts, you can run testscript_1.sh and testscript_2.sh. To know more about CLI, refer OpenWARPCLIdocumentation.pdf

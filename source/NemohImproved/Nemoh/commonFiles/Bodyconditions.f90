...
!   This module contain utilites relevant to the body conditions including radiation and wave
!   elevation.
!
!   @author TCSASSEMBLER
!   @version 1.1
...
!
        ...
        ALLOCATE(BodyConditions%Omega(Nproblems),&
                BodyConditions%Switch_Potential(Nproblems),&
...
!       --- 
        ...
        DEALLOCATE(BodyConditions%Omega,BodyConditions%Switch_potential,&
                   BodyConditions%Switch_FreeSurface,&
                   BodyConditions%Switch_Kochin,&

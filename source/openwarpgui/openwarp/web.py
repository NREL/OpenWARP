...
_LOGGER = logging.getLogger(__name__ + '.WebController')
...
class WebController:
    ...
    def upload_file(self, uploadedFile):
        ...
        helper.log_entrance(_LOGGER, signature, {'uploadedFile' : uploadedFile})
    ...
    def visualize(self):
        ...
        helper.log_entrance(_LOGGER, signature, None)
